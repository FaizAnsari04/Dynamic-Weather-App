...
const humidity = document.getElementById('humidity');
const windspeed= document.getElementById('windspeed');
const weather_img = document.querySelector('.weather-box img'); // Assuming this is where you want to display weather images
...
async function checkWeather(city) {
    ...
    desc.innerHTML = `${weather_data.weather[0].desc}`;
    humidity.innerHTML = `${weather_data.main.humidity}%`;
    windspeed.innerHTML = `${weather_data.wind.speed} Km/H`; // Assuming this is where the wind speed is
